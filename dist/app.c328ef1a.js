...
},{"ev-emitter":"../node_modules/ev-emitter/ev-emitter.js"}],"makeGridItem.js":[function(require,module,exports) {
"use strict";
...
var makeGridItem = function makeGridItem(imgUrl) {
  var div = document.createElement('div');
...
var _makeGridItem = _interopRequireDefault(require("./makeGridItem"));
...
var masonryInstance = new _masonryLayout.default('#gallery', {
  columnWidth: '.grid-sizer',
  itemSelector: '.grid-item',
  percentPosition: true,
  transitionDuration: '0.3s'
});
(0, _imagesloaded.default)('#gallery').on('progress', masonryInstance.layout.bind(masonryInstance));
fetch('https://pixabay.com/api/?key=4823621-792051e21e56534e6ae2e472f&q=dog&image_type=photo').then(function (res) {
  return res.json();
}).then(function (_ref) {
  ...
  var hits = _ref.hits;
  // webformatURL
  var elements = hits.map(function (hit) {
    return (0, _makeGridItem.default)(hit.webformatURL);
  }); // Добавить в DOM

  (_document$querySelect = document.querySelector('#gallery')).append.apply(_document$querySelect, _toConsumableArray(elements)); // Добавить к masonry под слежение


  masonryInstance.addItems(elements);
  (0, _imagesloaded.default)('#gallery').on('progress', masonryInstance.layout.bind(masonryInstance));
});
},{"masonry-layout":"../node_modules/masonry-layout/masonry.js","imagesloaded":"../node_modules/imagesloaded/imagesloaded.js","./makeGridItem":"makeGridItem.js","./styles.css":"styles.css"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
